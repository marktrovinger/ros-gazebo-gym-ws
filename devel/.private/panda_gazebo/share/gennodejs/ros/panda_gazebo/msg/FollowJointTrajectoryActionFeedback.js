...
class FollowJointTrajectoryActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowJointTrajectoryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowJointTrajectoryActionFeedback(null);
    ...
    data.feedback = FollowJointTrajectoryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FollowJointTrajectoryFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowJointTrajectoryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FollowJointTrajectoryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FollowJointTrajectoryFeedback()
    }
