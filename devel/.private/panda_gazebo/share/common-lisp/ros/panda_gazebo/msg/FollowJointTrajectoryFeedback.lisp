...
(cl:defmethod cl:initialize-instance :after ((m <FollowJointTrajectoryFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FollowJointTrajectoryFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_gazebo-msg:<FollowJointTrajectoryFeedback> is deprecated: use panda_gazebo-msg:FollowJointTrajectoryFeedback instead.")))
...
(cl:defmethod joint_names-val ((m <FollowJointTrajectoryFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_gazebo-msg:joint_names-val is deprecated.  Use panda_gazebo-msg:joint_names instead.")
  (joint_names m))

(cl:ensure-generic-function 'desired-val :lambda-list '(m))
(cl:defmethod desired-val ((m <FollowJointTrajectoryFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_gazebo-msg:desired-val is deprecated.  Use panda_gazebo-msg:desired instead.")
  (desired m))

(cl:ensure-generic-function 'actual-val :lambda-list '(m))
(cl:defmethod actual-val ((m <FollowJointTrajectoryFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_gazebo-msg:actual-val is deprecated.  Use panda_gazebo-msg:actual instead.")
  (actual m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <FollowJointTrajectoryFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_gazebo-msg:error-val is deprecated.  Use panda_gazebo-msg:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FollowJointTrajectoryFeedback>)))
  ...
  "panda_gazebo/FollowJointTrajectoryFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FollowJointTrajectoryFeedback)))
  "Returns string type for a message object of type 'FollowJointTrajectoryFeedback"
  "panda_gazebo/FollowJointTrajectoryFeedback")
