...
(cl:defmethod cl:initialize-instance :after ((m <AddBox-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddBox-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_gazebo-srv:<AddBox-request> is deprecated: use panda_gazebo-srv:AddBox-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <AddBox-request>))
...
(cl:defmethod frame_id-val ((m <AddBox-request>))
...
(cl:defmethod pose-val ((m <AddBox-request>))
...
(cl:defmethod size-val ((m <AddBox-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_gazebo-srv:size-val is deprecated.  Use panda_gazebo-srv:size instead.")
  (size m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AddBox-request>) istream)
  ...
  (cl:setf (cl:slot-value msg 'size) (cl:make-array 3))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AddBox-request>)))
  ...
  "33a045cab11c556ad20e54d951c3d3de")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AddBox-request)))
  "Returns md5sum for a message object of type 'AddBox-request"
  "33a045cab11c556ad20e54d951c3d3de")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddBox-request>)))
  ...
  (cl:format cl:nil "# Service that can be used to add a box to the planning scene.~%string name~%string frame_id~%geometry_msgs/Pose pose~%float64[3] size~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddBox-request)))
  "Returns full string definition for message of type 'AddBox-request"
  (cl:format cl:nil "# Service that can be used to add a box to the planning scene.~%string name~%string frame_id~%geometry_msgs/Pose pose~%float64[3] size~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <AddBox-request>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'size) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
...
(cl:defmethod cl:initialize-instance :after ((m <AddBox-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddBox-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_gazebo-srv:<AddBox-response> is deprecated: use panda_gazebo-srv:AddBox-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <AddBox-response>))
...
(cl:defmethod message-val ((m <AddBox-response>))
