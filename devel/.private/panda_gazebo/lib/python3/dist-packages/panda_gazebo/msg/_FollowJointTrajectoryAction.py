...
class FollowJointTrajectoryAction(genpy.Message):
  _md5sum = "b51c7644abd094150684c4b3caf25fbc"
  _type = "panda_gazebo/FollowJointTrajectoryAction"
...
"""
  ...
  _slot_types = ['panda_gazebo/FollowJointTrajectoryActionGoal','panda_gazebo/FollowJointTrajectoryActionResult','panda_gazebo/FollowJointTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = panda_gazebo.msg.FollowJointTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = panda_gazebo.msg.FollowJointTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = panda_gazebo.msg.FollowJointTrajectoryActionFeedback()
    else:
      self.action_goal = panda_gazebo.msg.FollowJointTrajectoryActionGoal()
      self.action_result = panda_gazebo.msg.FollowJointTrajectoryActionResult()
      self.action_feedback = panda_gazebo.msg.FollowJointTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.goal_tolerance:
        ...
        buff.write(_get_struct_3d().pack(_x.position, _x.velocity, _x.acceleration))
      _x = self
      buff.write(_get_struct_2iBd2i3I().pack(_x.action_goal.goal.goal_time_tolerance.secs, _x.action_goal.goal.goal_time_tolerance.nsecs, _x.action_goal.goal.create_time_axis, _x.action_goal.goal.time_axis_step, _x.action_goal.goal.timeout.secs, _x.action_goal.goal.timeout.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_feedback.feedback.error.positions))
      length = len(self.action_feedback.feedback.error.velocities)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_feedback.feedback.error.velocities))
      length = len(self.action_feedback.feedback.error.accelerations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_feedback.feedback.error.accelerations))
      length = len(self.action_feedback.feedback.error.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_feedback.feedback.error.effort))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.goal_time_tolerance.secs, _x.action_goal.goal.goal_time_tolerance.nsecs, _x.action_goal.goal.create_time_axis, _x.action_goal.goal.time_axis_step, _x.action_goal.goal.timeout.secs, _x.action_goal.goal.timeout.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_2iBd2i3I().unpack(str[start:end])
      self.action_goal.goal.create_time_axis = bool(self.action_goal.goal.create_time_axis)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.action_feedback.feedback.error.positions = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_feedback.feedback.error.velocities = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_feedback.feedback.error.accelerations = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_feedback.feedback.error.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 8
...
def _get_struct_2i():
    ...
    if _struct_2i is None:
        _struct_2i = struct.Struct("<2i")
    return _struct_2i
_struct_2iBd2i3I = None
def _get_struct_2iBd2i3I():
    global _struct_2iBd2i3I
    if _struct_2iBd2i3I is None:
        _struct_2iBd2i3I = struct.Struct("<2iBd2i3I")
    return _struct_2iBd2i3I
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
