...
class FollowJointTrajectoryActionResult(genpy.Message):
  _md5sum = "5d23478b6586cdc80968f3fb64765980"
  _type = "panda_gazebo/FollowJointTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','panda_gazebo/FollowJointTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = panda_gazebo.msg.FollowJointTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = panda_gazebo.msg.FollowJointTrajectoryResult()
