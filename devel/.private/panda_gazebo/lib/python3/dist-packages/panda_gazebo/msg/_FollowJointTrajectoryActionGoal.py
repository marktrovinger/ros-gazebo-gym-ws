...
class FollowJointTrajectoryActionGoal(genpy.Message):
  _md5sum = "e5dfdfde003fbe231d7141be8b8992c2"
  _type = "panda_gazebo/FollowJointTrajectoryActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','panda_gazebo/FollowJointTrajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = panda_gazebo.msg.FollowJointTrajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = panda_gazebo.msg.FollowJointTrajectoryGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.goal.goal_tolerance:
        ...
        buff.write(_get_struct_3d().pack(_x.position, _x.velocity, _x.acceleration))
      _x = self
      buff.write(_get_struct_2iBd2i().pack(_x.goal.goal_time_tolerance.secs, _x.goal.goal_time_tolerance.nsecs, _x.goal.create_time_axis, _x.goal.time_axis_step, _x.goal.timeout.secs, _x.goal.timeout.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.goal_time_tolerance.secs, _x.goal.goal_time_tolerance.nsecs, _x.goal.create_time_axis, _x.goal.time_axis_step, _x.goal.timeout.secs, _x.goal.timeout.nsecs,) = _get_struct_2iBd2i().unpack(str[start:end])
      self.goal.create_time_axis = bool(self.goal.create_time_axis)
      return self
